...
class OpsTools:
    """Schedule CRUD, triggering, and schedule-job listing tools."""
    ...
    @mcp.tool(
        ...
        description=(
            "List all STAF schedules. Set enabled_only to filter " "out disabled schedules."
        ),
        annotations=ToolAnnotations(
            readOnlyHint=True,
            destructiveHint=False,
    ...
    @mcp.tool(
        ...
        description=(
            "Delete a schedule permanently. Running jobs spawned by this "
