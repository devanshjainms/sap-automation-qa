...
def triage_sap_cluster(
    ...
    steps = (
        ...
        "2. Once collection completes, call run_analysis with the "
        "returned session_id to evaluate against SAP HA rules.\n"
        "3. Call get_triage_report with the session_id to get the "
        "formatted findings.\n"
        "4. Summarize the critical findings and provide actionable "
        "remediation steps.\n"
    )
