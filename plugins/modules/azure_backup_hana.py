...
try:
    ...
    from plugins.module_utils.enums import TestStatus, BackupOperation
    from plugins.module_utils.backup_discovery import BackupDiscovery
    from plugins.module_utils.backup_restore import BackupRestoreHelper
